    ...
    public static class TournamentLogic
    {
        ...
        private static void CompleteTournament(TournamentModel model)
        {
            ...
            if (model.Prizes.Count > 0)
            {
                ...
                PrizeModel firstPlacePrize = model.Prizes.Where(x => x.PlaceNumber == 1).FirstOrDefault();  // Find the First or in case there isn't set null as Default
        ...
        private static void MarkWinnerInMatchups(List<MatchupModel> models)
        {
            ...
            foreach (MatchupModel m  in models)
            {
                ...
                {
                    // 1 mean true, or hugh score wins
                    if (m.Entries[0].Score > m.Entries[1].Score)
                    {
                        m.Winner = m.Entries[0].TeamCompeting;
                    }
        ...
        {
            int output = 1; // number of rounds
            int val = 2;    // number of teams added

...
namespace TrackerUI
{
    public partial class TournamentViewerForm : Form
    {
        ...
        BindingList<MatchupModel> selectedMatchups = new BindingList<MatchupModel>();  // F12 sull'oggetto e passa alla definizione
        ...
        private void LoadRounds()
        {
            ...
            LoadMatchups(1);    // Load the round 1
        }
        ...
        private void LoadMatchups(int round)
        {
            foreach (List<MatchupModel> matchups in tournament.Rounds)
            {
                if (matchups.First().MatchupRound == round)
                {
                    ...
                    {
                        if (m.Winner == null || !UnpleyedOnlyCheckBox.Checked)
                        {
        ...
        private void UnpleyedOnlyCheckBox_CheckedChanged(object sender, EventArgs e)
        {
            LoadMatchups((int)roundDropDown.SelectedItem);
        }
